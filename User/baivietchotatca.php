    ...
    <div id="tong">
        <div id="tren">
            <div id="err">
                ...
                $sql1 = "SELECT * FROM bai_viet WHERE maBaiViet='$makhuvuc'";
                $result1 = mysqli_query($con, $sql1);
                $bai_viet = mysqli_fetch_array($result1);
                mysqli_close($con);
                ?>
                <div id="nut-quay-lai">
        ...
        <div id="duoi">
            ...
            <div id="duoi2">
                <div id="duoi2-1">
                    ...
                    <hr width="60%" align="center" color="black" size="1" />
                    <br />
                    <h3>Những ý kiến đánh giá sâu sắc <3 </h3>
                            <?php
                            $con = mysqli_connect("localhost", "root", "", "hanoi_view");
                            ...
                            <form action="Dang-nhap.php">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <div id="nut-bam">
                                                <button onclick=" return confirm('Trước tiên bạn phải đăng nhập')">Bình
                                                    luận</button>
                                            </div>
                                        </td>
                                    </tr>
